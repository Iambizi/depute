...
<Callout>
  **Interactive Demo:** See the [Storybook catalog](https://iambizi.github.io/depute/?path=/story/ax-components-v1-agentroster--default) for live interactive examples of AgentRoster.
</Callout>

<StorybookEmbed story="ax-components-v1-agentroster--default" height={400} />
