...
A dense table view designed for the "Flat Swarm" orchestration model (e.g., [OpenAI's Swarm](https://github.com/openai/swarm)). It allows a human supervisor to scan 20+ concurrent workers at a glance, monitoring roll-up metrics like agent status, uptime, and token cost.
