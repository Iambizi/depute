...
While the preview above is static, here is the fully interactive component allowing you to cycle between pending, approved, and rejected states, and view the scoped variants.

<StorybookEmbed story="ax-components-v1-approvalgate--default" height={360} />
