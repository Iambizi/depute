...
While the preview above is static, here is the fully interactive component allowing you to cycle through the execution states of a specific workflow subtree.

<StorybookEmbed story="ax-components-v1-branchcontrols--default" height={360} />
