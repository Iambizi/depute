...
import { BranchControlsDemo } from '@/components/demos/BranchControlsDemo';
...
```
  ...
  <Tab value="pnpm">
```bash
pnpm dlx ax-depute add branch-controls
```
  </Tab>
  <Tab value="yarn">
```bash
yarn dlx ax-depute add branch-controls
```
  </Tab>
  <Tab value="bun">
```bash
bunx ax-depute add branch-controls
```
  </Tab>
</Tabs>
...
<StorybookEmbed story="ax-components-v1-branchcontrols--default" />
