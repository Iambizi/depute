...
**Why quantitative trust signaling?**  Humans struggle to calibrate trust in LLMs. By surfacing a confidence score *before* execution, the UI shifts from a "black box" to a measurable partnership — giving the human a concrete signal to react to rather than just a gut feeling.
