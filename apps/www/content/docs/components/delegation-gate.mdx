...
<Callout>
  **Interactive Demo:** See the [Storybook catalog](https://iambizi.github.io/depute/?path=/story/delegationgate--default) for live interactive examples of DelegationGate.
</Callout>
