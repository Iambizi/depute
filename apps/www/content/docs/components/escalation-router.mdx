...
import { EscalationRouterDemo } from '@/components/demos/EscalationRouterDemo';
...
<StorybookEmbed story="ax-components-v1-escalationrouter--default" />
