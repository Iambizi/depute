...
<Callout>
  **Interactive Demo:** See the [Storybook catalog](https://iambizi.github.io/depute/?path=/story/handoffprotocol--default) for live interactive examples of HandoffProtocol.
</Callout>
