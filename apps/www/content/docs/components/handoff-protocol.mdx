...
import { HandoffProtocolDemo } from '@/components/demos/HandoffProtocolDemo';
...
```
  ...
  <Tab value="pnpm">
```bash
pnpm dlx ax-depute add handoff-protocol
```
  </Tab>
  <Tab value="yarn">
```bash
yarn dlx ax-depute add handoff-protocol
```
  </Tab>
  <Tab value="bun">
```bash
bunx ax-depute add handoff-protocol
```
  </Tab>
</Tabs>
