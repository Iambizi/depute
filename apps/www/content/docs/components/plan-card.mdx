...
While the preview above is static, here is the fully interactive component where you can step through execution from pending, to active, to completed/failed statuses.

<StorybookEmbed story="ax-components-v1-plancard--default" height={380} />
