...
<Callout>
  **Interactive Demo:** See the [Storybook catalog](https://iambizi.github.io/depute/?path=/story/sharedcontextledger--default) for live interactive examples of SharedContextLedger.
</Callout>
