...
import { SharedContextLedgerDemo } from '@/components/demos/SharedContextLedgerDemo';
...
```
  ...
  <Tab value="pnpm">
```bash
pnpm dlx ax-depute add shared-context-ledger
```
  </Tab>
  <Tab value="yarn">
```bash
yarn dlx ax-depute add shared-context-ledger
```
  </Tab>
  <Tab value="bun">
```bash
bunx ax-depute add shared-context-ledger
```
  </Tab>
</Tabs>
