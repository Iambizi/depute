...
<Callout>
  **Interactive Demo:** See the [Storybook catalog](https://iambizi.github.io/depute/?path=/story/ax-components-v1-subagentcard--default) for live interactive examples of SubagentCard.
</Callout>

<StorybookEmbed story="ax-components-v1-subagentcard--default" height={300} />
