...
<Callout>
  **Interactive Demo:** See the [Storybook catalog](https://iambizi.github.io/depute/?path=/story/ax-components-v1-swarminbox--default) for live interactive examples of SwarmInbox.
</Callout>

<StorybookEmbed story="ax-components-v1-swarminbox--default" height={400} />
