...
<Callout>
  **Interactive Demo:** See the [Storybook catalog](https://iambizi.github.io/depute/?path=/story/ax-components-v1-swarmmonitor--default) for live interactive examples of SwarmMonitor.
</Callout>

<StorybookEmbed story="ax-components-v1-swarmmonitor--default" height={400} />
