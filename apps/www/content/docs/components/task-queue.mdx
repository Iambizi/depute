...
import { TaskQueueDemo } from '@/components/demos/TaskQueueDemo';
...
```
  ...
  <Tab value="pnpm">
```bash
pnpm dlx ax-depute add task-queue
```
  </Tab>
  <Tab value="yarn">
```bash
yarn dlx ax-depute add task-queue
```
  </Tab>
  <Tab value="bun">
```bash
bunx ax-depute add task-queue
```
  </Tab>
</Tabs>
...
<StorybookEmbed story="ax-components-v1-taskqueue--default" />
