...
This command drops a `skills/depute/SKILL.md` file into your project, automatically giving Claude Code, Cursor, or Copilot deep intelligence on how to use Depute's 18 primitives in your specific codebase.
