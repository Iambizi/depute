...
}`,...C.parameters?.docs?.source}}};const ae=["Default","AllFeatures","TypeMarkdown","TypeJSON","TypeCSV","TypeCode","PrototypeQuickStart","TestVariations","SimulateRealTimeUpdates","BasicUsage","WithRealAPIData","ErrorHandling"];export{y as AllFeatures,k as BasicUsage,x as Default,C as ErrorHandling,v as PrototypeQuickStart,j as SimulateRealTimeUpdates,S as TestVariations,w as TypeCSV,g as TypeCode,f as TypeJSON,h as TypeMarkdown,_ as WithRealAPIData,ae as __namedExportsOrder,ne as default};
