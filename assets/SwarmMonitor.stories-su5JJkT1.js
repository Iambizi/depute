import{j as a}from"./jsx-runtime-u17CrQMm.js";import{m as r}from"./mockData-DOQp8R7v.js";const h="_base_113fo_3",k="_header_113fo_13",R="_title_113fo_22",b="_controls_113fo_28",v="_btnPause_113fo_33",C="_btnKill_113fo_34",N="_grid_113fo_61",x="_metric_113fo_67",S="_metricValue_113fo_81",f="_metricLabel_113fo_89",j="_metricError_medium_113fo_98",w="_metricError_low_113fo_99",I="_metricError_high_113fo_100",y="_dot_113fo_108",T="_dotWorking_113fo_117",E="_smPulse_113fo_1",B="_dotIdle_113fo_118",M="_completionRow_113fo_126",$="_completionLabel_113fo_133",P="_progressBar_113fo_142",L="_progressFill_113fo_150",V="_completionValue_113fo_157",e={base:h,header:k,title:R,controls:b,btnPause:v,btnKill:C,grid:N,metric:x,metricValue:S,metricLabel:f,metricError_medium:j,metricError_low:w,metricError_high:I,dot:y,dotWorking:T,smPulse:E,dotIdle:B,completionRow:M,completionLabel:$,progressBar:P,progressFill:L,completionValue:V},p=({className:g,metrics:t,onGlobalPause:d,onGlobalKill:u})=>{const _=t.errorRate>25?"high":t.errorRate>10?"medium":"low";return a.jsxs("div",{className:`${e.base} ${g||""}`,role:"region","aria-label":"Swarm Monitor",children:[a.jsxs("div",{className:e.header,children:[a.jsx("span",{className:e.title,children:"Swarm Monitor"}),a.jsxs("div",{className:e.controls,children:[d&&a.jsx("button",{className:e.btnPause,onClick:d,"aria-label":"Pause all agents",children:"⏸ Pause All"}),u&&a.jsx("button",{className:e.btnKill,onClick:u,"aria-label":"Kill all agents",children:"⏹ Kill All"})]})]}),a.jsxs("div",{className:e.grid,children:[a.jsxs("div",{className:e.metric,children:[a.jsx("span",{className:e.metricValue,children:t.activeInstances}),a.jsx("span",{className:e.metricLabel,children:"Active"}),a.jsx("span",{className:`${e.dot} ${e.dotWorking}`})]}),a.jsxs("div",{className:e.metric,children:[a.jsx("span",{className:e.metricValue,children:t.idleInstances}),a.jsx("span",{className:e.metricLabel,children:"Idle"}),a.jsx("span",{className:`${e.dot} ${e.dotIdle}`})]}),a.jsxs("div",{className:e.metric,children:[a.jsx("span",{className:e.metricValue,children:t.totalCost}),a.jsx("span",{className:e.metricLabel,children:"Total Cost"})]}),a.jsxs("div",{className:e.metric,children:[a.jsxs("span",{className:e.metricValue,children:[(t.tokensBurned/1e3).toFixed(1),"k"]}),a.jsx("span",{className:e.metricLabel,children:"Tokens"})]}),a.jsxs("div",{className:`${e.metric} ${e[`metricError_${_}`]??""}`,children:[a.jsxs("span",{className:e.metricValue,children:[t.errorRate,"%"]}),a.jsx("span",{className:e.metricLabel,children:"Error Rate"})]}),t.estimatedTimeRemaining&&a.jsxs("div",{className:e.metric,children:[a.jsx("span",{className:e.metricValue,children:t.estimatedTimeRemaining}),a.jsx("span",{className:e.metricLabel,children:"ETA"})]})]}),t.taskCompletionRate!=null&&a.jsxs("div",{className:e.completionRow,children:[a.jsx("span",{className:e.completionLabel,children:"Completion"}),a.jsx("div",{className:e.progressBar,children:a.jsx("div",{className:e.progressFill,style:{width:`${t.taskCompletionRate}%`},role:"progressbar","aria-valuenow":t.taskCompletionRate,"aria-valuemin":0,"aria-valuemax":100})}),a.jsxs("span",{className:e.completionValue,children:[t.taskCompletionRate,"%"]})]})]})};p.__docgenInfo={description:`SwarmMonitor is the macro-dashboard for the entire swarm.
