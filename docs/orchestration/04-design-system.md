...
Under the **depute** model, these tokens are **copied into the consumer repo** (e.g. `src/styles/ax-theme.css`) so teams can theme without forking the component logic.
